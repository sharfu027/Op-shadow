...
public sealed class SecurityAuditLogConfiguration : IEntityTypeConfiguration<SecurityAuditLog>
{
    public void Configure(EntityTypeBuilder<SecurityAuditLog> builder)
    {
        ...
        builder.Property(sal => sal.CorrelationId).HasMaxLength(100).IsRequired();
        builder.Property(sal => sal.RequestId).HasMaxLength(100).IsRequired();
        ...
        builder.HasIndex(sal => sal.CorrelationId).HasDatabaseName("idx_security_audit_logs_correlation_id");
        builder.HasIndex(sal => sal.EntityId).HasDatabaseName("idx_security_audit_logs_entity_id");
